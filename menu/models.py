...
class FoodItem(models.Model):
    ...
    dish_name = maodels.Charfield(max_length=220, unique=True)
    description = models.Charfield(max_length=220, unique=True)
    price = models.FloatField()
    Food_Menu_Section = models.IntergerField(choices=Food_Menu_Section, default=1)
...
class DrinkItem(models.Model):
    ...
    price = models.FloatField()
    Drink_menu_section = models.IntergerField(choices=Food_Menu_Section, default=1)
    on_menu = models.BooleanField(default=False)
    updated_on = models.DateTimeField(auto_now=True)
